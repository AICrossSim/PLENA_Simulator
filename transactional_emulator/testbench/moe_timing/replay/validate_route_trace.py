...
#: Version written by :func:`sample_trace` and the generators.
...
def main() -> int:
    ...
    summary = {
        # The version this validator implements, not the one the trace declared --
        # the latter is reported separately so a summary shows both.
