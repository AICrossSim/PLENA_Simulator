...
DEFAULT_OUT_ROOT = PLENA_ROOT / "outputs" / "window1_p1"
            ...
            stage_rows.append(
                {
                    ...
                    "physical_hbm_bytes_read": stage_data.get("physical_hbm_bytes_read", stage_data.get("hbm_bytes_read")),
                    "physical_hbm_bytes_written": stage_data.get("physical_hbm_bytes_written", stage_data.get("hbm_bytes_written")),
