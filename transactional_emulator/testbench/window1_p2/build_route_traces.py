...
def _trace_id(record: dict[str, Any]) -> str:
    ...
    return stable_id(
        f"{record['model_key']}_{record['benchmark']}_{record['sample_id']}_"
        f"l{record['layer']}_{phase}{suffix}"
    )
...
def trace_from_record(
    ...
    *,
    ...
    trace = {
        ...
        "created_by": "transactional_emulator.testbench.window1_p2.build_route_traces",
        ...
        "artifacts": {
            "reference_pt": "generated_by_window1_p2_qwen3_trace_replay",
            "l1_golden_pt": "generated_by_window1_p2_qwen3_trace_replay",
        },
        "replay": {
            "harness_module": "transactional_emulator.testbench.window1_p2.qwen3_trace_replay_test",
            "stage": "full_vram",
            "mlen": mlen,
            "blen": blen,
