...
_REPOS_ROOT = Path(__file__).resolve().parents[4]
_TOP_LEVEL_COMPILER = _REPOS_ROOT / "PLENA_Compiler"
...
from transactional_emulator.testbench.models.gpt_oss.attention_semantics_test import _comparison_params
