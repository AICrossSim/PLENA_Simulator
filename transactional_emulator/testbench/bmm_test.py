...
if __name__ == "__main__":
    ...
    golden_result = {"input_tensor": input_tensor, "weights": weight_2_tensor, "original_output": original_output}

    gen_assembly_code = "; Linear Test Generation \n"

    # Set the addr offset for weight and bias
    gen_assembly_code += preload_addr_reg_asm(
        addr_reg_to_set=[1], available_registers=[1], addr_reg_val=[int(m * k * batch_size * real_data_ratio)]
    )
