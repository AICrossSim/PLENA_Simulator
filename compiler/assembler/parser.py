...
if __name__ == "__main__":
    # Example usage:
    #   python -m compiler.assembler.parser <path/to/file.asm>
    # (to dump an ISA enum instead, call load_isa_definitions(<path/to/operation.svh>))
    import sys

    if len(sys.argv) != 2:
        print("usage: python -m compiler.assembler.parser <file.asm>")
        sys.exit(1)
